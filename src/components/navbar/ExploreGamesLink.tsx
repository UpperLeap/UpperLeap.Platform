...
const ExploreGamesLink = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex space-x-2 items-center z-10 rounded-full bg-background-light dark:bg-background-dark py-0.5 px-4 ring-1 dark:ring-white/20 ring-black/20">
